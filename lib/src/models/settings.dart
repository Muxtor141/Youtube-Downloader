...
class ThemeSetting {
  ...
  static final ThemeSetting light = ThemeSetting._(
      0,
      ThemeData.light().copyWith(tabBarTheme: TabBarTheme(labelColor: Colors.white),
  ...
  static final ThemeSetting dark = ThemeSetting._(
      1,
      ThemeData.dark().copyWith(tabBarTheme: TabBarTheme(labelColor: Colors.red.withOpacity(0.8)),
       appBarTheme: AppBarTheme(shadowColor: Colors.red.withOpacity(0.8),elevation: 5),
